...
import cn.rwj.framework.spring.context.ConfigurableApplicationContext;
import cn.rwj.framework.spring.cores.io.DefaultResourceLoader;

import java.util.Map;

/**
 * {@link cn.rwj.framework.spring.context.ApplicationContext}接口的抽象实现，
 * 不强制规定用于配置的存储类型；只需实现常见的上下文功能。使用模板方法设计模式，要求具体子类实现抽象方法。
 *
 * @author rwj
 * @since 2024/10/15
 */
